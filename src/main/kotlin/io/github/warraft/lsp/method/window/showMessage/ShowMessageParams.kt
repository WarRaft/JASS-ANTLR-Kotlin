package io.github.warraft.lsp.method.window.showMessage
...
@Serializable
data class ShowMessageParams(val type: MessageType, val message: String) : Params {
    @Transient
    override val method: String = "window/showMessage"
}
