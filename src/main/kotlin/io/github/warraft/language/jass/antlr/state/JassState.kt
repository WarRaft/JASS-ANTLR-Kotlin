...
import io.github.warraft.language.jass.antlr.state.ext.lsp.completionExt
import io.github.warraft.language.jass.antlr.state.ext.lsp.definitionExt
import io.github.warraft.language.jass.antlr.state.ext.lsp.documentHighlightExt
import io.github.warraft.language.jass.antlr.state.ext.lsp.formatting.formattingEx
import io.github.warraft.language.jass.antlr.state.ext.lsp.hoverExt
import io.github.warraft.language.jass.antlr.state.ext.lsp.referencesExt
import io.github.warraft.language.jass.antlr.state.ext.lsp.signatureHelpExt
...
class JassState : LanguageState() {
    ...
    override fun definition(position: Position): MutableList<LocationLink>? = definitionExt(position)
